...
from consts_mensagem import CODIGO_COMANDO, CODIGO_RESPOSTA, COMANDO_EFETUAR_JOGADA, JOGADA_LINHA, JOGADA_COLUNA ,COMANDO_SHOW, IMPRIMA, QTD
...
def qtd_jogadas():
    ...
    #print("IMPRIMIR O RESULTADO!!!!!!!!!!" , mensagem)
